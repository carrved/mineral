...
public class Gui
{
     ...
     */
    public void drawCenteredString(FontRenderer fontRendererObj, String text, int x, int y, int color)
    {
        fontRendererObj.drawStringWithShadow(text, (float)(x - fontRendererObj.getStringWidth(text) / 2), (float)y, color);
    }
